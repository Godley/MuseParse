...
setup(
    ...
    description='A package which takes an inputted music file (at the moment only MusicXML) and generates an object hierarchy in memory. This can then be outputted (currently only to lilypond)'
)
