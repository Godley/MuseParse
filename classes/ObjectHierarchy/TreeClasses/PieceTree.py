...
from classes.ObjectHierarchy.TreeClasses import PartNode
from classes.ObjectHierarchy.TreeClasses.BaseTree import Tree, IndexedNode
from classes.ObjectHierarchy.ItemClasses import Piece
